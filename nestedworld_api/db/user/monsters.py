...
class UserMonster(db.Model):
    ...
    monster = db.relationship('Monster', cascade="all, delete-orphan", single_parent=True, backref=db.backref('user_monsters'))
    user = db.relationship('User', cascade="all, delete-orphan", single_parent=True, backref=db.backref('user_monsters'))
