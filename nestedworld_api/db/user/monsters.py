...
class UserMonster(db.Model):
    ...
    monster = db.relationship('Monster', cascade="all, delete", backref=db.backref('user_monsters'))
    user = db.relationship('User', cascade="all, delete", backref=db.backref('user_monsters'))
