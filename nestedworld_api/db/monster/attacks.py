...
class MonsterAttack(db.Model):
    ...
    monster = db.relationship('Monster', cascade="all, delete-orphan", single_parent=True, backref="monster_attack")
    attack = db.relationship('Attack', cascade="all, delete-orphan", single_parent=True, backref="attack")
